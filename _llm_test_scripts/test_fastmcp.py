...
async def test_server_and_agentic_tools():
    try:
        from src.davinci_resolve_mcp.server import app
...
async def run_all_tests():
    print("Testing FastMCP 2.14.3 SOTA updates for DaVinci Resolve MCP...")
    ...
    if success:
        ...
        print("- Agentic Resolve workflow orchestration")
        print("- Intelligent video processing")
        print("- Conversational Resolve assistant")
    else:
