...
async def get_audio_tracks(app, timeline_name: str | None = None) -> dict[str, Any]:
    """
...
async def get_audio_tracks_impl(app, timeline_name: str | None = None) -> dict[str, Any]:
    """
...
def register_tools(app):
    ...
    @app.tool()
    async def get_audio_tracks(timeline_name: str | None = None) -> dict[str, Any]:
        """
        Get information about all audio tracks in the current or specified timeline.
