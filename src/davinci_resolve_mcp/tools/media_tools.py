...
async def get_media_metadata_impl(app, clip_path: str) -> Dict[str, Any]:
    ...
    try:
        ...
        # Get clip properties
        properties = [
            "Type", "Duration", "Frame Rate", "Resolution Width", "Resolution Height",
            "PAR", "DAR", "Audio Channels", "Audio Sample Rate", "Bit Depth",
            "Codec", "File Path", "File Size", "Date Created", "Date Modified"
        ]
