...
class ResolveConnectionError(DaVinciResolveMCPError):
    ...
    def __init__(self, message: str):
        super().__init__(
            message,
            recovery_action="ensure_resolve_running"
        )
...
class ResolveAPIError(DaVinciResolveMCPError):
    ...
    def __init__(self, message: str):
        super().__init__(
            message,
            recovery_action="check_api_compatibility"
        )
...
class ProjectOperationError(DaVinciResolveMCPError):
    ...
    def __init__(self, message: str):
        super().__init__(
            message,
            recovery_action="check_project_state"
        )
...
class MediaPoolError(DaVinciResolveMCPError):
    ...
    def __init__(self, message: str):
        super().__init__(
            message,
            recovery_action="check_media_pool_state"
        )
...
class TimelineNotFoundError(TimelineError):
    ...
    def __init__(self, timeline_name: str):
        super().__init__(
            ...
            recovery_action="list_available_timelines"
        )
...
class ColorGradingError(DaVinciResolveMCPError):
    ...
    def __init__(self, message: str):
        super().__init__(
            message,
            recovery_action="check_color_page_state"
        )
...
class RenderQueueError(RenderError):
    ...
    def __init__(self, message: str):
        super().__init__(
            f"Render queue error: {message}",
            recovery_action="check_render_queue_state"
        )
...
class EnvironmentError(DaVinciResolveMCPError):
    ...
    def __init__(self, message: str):
        super().__init__(
            message,
            recovery_action="setup_environment"
        )
...
class ValidationError(DaVinciResolveMCPError):
    ...
    def __init__(self, field: str, value: any, reason: str = None):
        ...
        super().__init__(
            message,
            recovery_action="check_input_parameters"
        )
...
class UnsupportedFormatError(DaVinciResolveMCPError):
    ...
    def __init__(self, file_path: str, format_type: str = None):
        ...
        super().__init__(
            message,
            recovery_action="convert_to_supported_format"
        )
...
class ResourceNotAvailableError(DaVinciResolveMCPError):
    ...
    def __init__(self, resource: str):
        super().__init__(
            f"Resource not available: {resource}",
            recovery_action="check_resource_availability"
        )
