...
class MediaMetadata(ResolveObject):
    ...
    duration: Optional[TimeCode] = Field(default=None, description="Duration of the media")
    start_timecode: Optional[TimeCode] = Field(default=None, description="Starting timecode")
    ...
    color_space: Optional[ColorSpace] = Field(default=None, description="Color space")
    resolution: Optional[Resolution] = Field(default=None, description="Resolution")
    frame_rate: Optional[FrameRate] = Field(default=None, description="Frame rate")
...
class MediaItem(ResolveObject):
    ...
    in_point: Optional[TimeCode] = Field(default=None, description="In point timecode")
    out_point: Optional[TimeCode] = Field(default=None, description="Out point timecode")
    duration: Optional[TimeCode] = Field(default=None, description="Duration")
    ...
    proxy_path: Optional[str] = Field(default=None, description="Proxy media path")
...
class ImportSettings(ResolveObject):
    ...
    source_paths: List[Union[str, Path]] = Field(default_factory=list, description="Source file/folder paths")
...
class MediaPoolBin(ResolveObject):
    ...
    parent_path: Optional[str] = Field(default=None, description="Parent bin path")
...
class MediaPool(ResolveObject):
    ...
    bins: List[Union[MediaPoolBin, SmartBin]] = Field(default_factory=list, description="List of bins")
    selected_bin: Optional[str] = Field(default=None, description="Selected bin path")
