...
class AudioClip(ResolveObject):
    ...
    sample_rate: AudioSampleRate = Field(
        default=AudioSampleRate.KHZ_48,
        description="Sample rate in Hz"
    )
    bit_depth: AudioBitDepth = Field(
        default=AudioBitDepth.BIT_24,
    ...
    channel_layout: AudioChannelLayout = Field(
        default=AudioChannelLayout.STEREO,
    ...
    start_timecode: Optional[TimeCode] = Field(
        default=None,
        description="Start timecode"
    )
    end_timecode: Optional[TimeCode] = Field(
        default=None,
    ...
    is_muted: bool = Field(
        default=False,
        description="Muted status"
    )
    is_soloed: bool = Field(
        default=False,
        description="Soloed status"
    )
    ...
    volume: float = Field(
        default=0.0,
        description="Volume in dB (0.0 = unity, -inf = muted)"
    )
    pan: float = Field(
        default=0.0,
        ge=-1.0,
    ...
    is_music: bool = Field(
        default=False,
        description="Music track flag"
    )
    is_dialogue: bool = Field(
        default=False,
        description="Dialogue track flag"
    )
    is_sfx: bool = Field(
        default=False,
        description="Sound effects track flag"
    )
    is_ambience: bool = Field(
        default=False,
        description="Ambience track flag"
    )
    is_foley: bool = Field(
        default=False,
        description="Foley track flag"
    )
...
class AudioEffect(ResolveObject):
    ...
    preset_name: Optional[str] = Field(
        default=None,
        description="Name of the preset (if any)"
    )
...
class AudioTrack(ResolveObject):
    ...
    effects: List[AudioEffect] = Field(
        default_factory=list,
    ...
    automation_mode: str = Field(
        default="read",
        description="Automation mode (read, touch, latch, write)"
    )
    is_folded: bool = Field(
        default=False,
        description="Folded status in UI"
    )
    color: str = Field(
        default="None",
...
class AudioBus(ResolveObject):
    ...
    bus_type: AudioTrackType = Field(
        default=AudioTrackType.STEREO,
        description="Type of audio bus"
    )
    is_master: bool = Field(
        default=False,
        description="Master bus status"
    )
    is_solo_safe: bool = Field(
        default=False,
        description="Solo safe status"
    )
    is_muted: bool = Field(
        default=False,
        description="Muted status"
    ...
    input_routing: Dict[str, Any] = Field(
        default_factory=dict,
        description="Input routing configuration"
    )
...
class AudioMixer(ResolveObject):
    ...
    audio_buses: Dict[str, AudioBus] = Field(
        default_factory=dict,
        description="Dictionary of audio buses by name"
    )
    audio_tracks: List[AudioTrack] = Field(
        default_factory=list,
        description="List of audio tracks"
    )
    is_audio_metering_enabled: bool = Field(
        default=True,
        description="Audio metering status"
    )
    is_automation_enabled: bool = Field(
        default=True,
        description="Automation status"
    )
    is_snapping_enabled: bool = Field(
        default=True,
        description="Snapping status"
    )
    is_loop_playback_enabled: bool = Field(
        default=False,
        description="Loop playback status"
    )
    is_solo_in_place_enabled: bool = Field(
        default=False,
        description="Solo in place status"
    )
    is_track_solo_isolate_enabled: bool = Field(
        default=False,
        description="Track solo isolate status"
    )
    is_auto_ducking_enabled: bool = Field(
        default=False,
        description="Auto ducking status"
    )
    is_loudness_normalization_enabled: bool = Field(
        default=False,
        description="Loudness normalization status"
    )
    ...
    is_dialog_intelligence_enabled: bool = Field(
        default=False,
        description="Dialog intelligence status"
    )
    is_audio_detection_enabled: bool = Field(
        default=True,
        description="Audio detection status"
    )
    is_audio_waveform_enabled: bool = Field(
        default=True,
        description="Audio waveform display status"
    )
    is_audio_spectrum_enabled: bool = Field(
        default=False,
        description="Audio spectrum display status"
    )
    is_audio_phase_scope_enabled: bool = Field(
        default=False,
        description="Audio phase scope status"
    )
    is_audio_goniometer_enabled: bool = Field(
        default=False,
        description="Audio goniometer status"
    )
    is_audio_correlation_meter_enabled: bool = Field(
        default=False,
        description="Audio correlation meter status"
    )
    metadata: Dict[str, Any] = Field(
        default_factory=dict,
        description="Additional metadata"
    ...
    def get_audio_bus(self, bus_name: str) -> Optional[AudioBus]:
    ...
    def get_audio_track(self, track_index: int) -> Optional[AudioTrack]:
