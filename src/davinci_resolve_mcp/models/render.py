...
class RenderPreset(ResolveObject):
    ...
    bitrate: int | None = Field(default=None, ge=100, description="Bitrate in kbps")
...
class RenderJob(ResolveObject):
    ...
    output_path: str | Path = Field(..., description="Output directory or file path")
    ...
    start_frame: int | None = Field(default=None, ge=0, description="Start frame")
    end_frame: int | None = Field(default=None, ge=0, description="End frame")
    in_point: TimeCode | None = Field(default=None, description="In point")
    out_point: TimeCode | None = Field(default=None, description="Out point")

    # Override settings
    resolution: Resolution | None = Field(default=None, description="Override resolution")
    frame_rate: FrameRate | None = Field(default=None, description="Override frame rate")
    format: RenderFormat | None = Field(default=None, description="Override format")
    ...
    def get_estimated_file_size(self) -> float | None:
        """
