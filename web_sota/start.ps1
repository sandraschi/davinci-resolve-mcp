...
$backendCmd = "`$env:PYTHONPATH = '$ProjectRoot;$ProjectRoot\src'; Set-Location '$ProjectRoot'; uv run python -m uvicorn davinci_resolve_mcp.server:api_app --host 127.0.0.1 --port $BackendPort --log-level info"
