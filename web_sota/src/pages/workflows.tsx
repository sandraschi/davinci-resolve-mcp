    ...
    steps: [
      {
        tool: "resolve_media",
        action: "import",
        description: "Import raw footage",
        icon: Upload,
      },
      {
        tool: "resolve_timeline",
        action: "create",
        description: "Create edit timeline",
        icon: Clock,
      },
      {
        tool: "resolve_timeline",
        action: "add_clip",
        description: "Add clips to timeline",
        icon: Film,
      },
      {
        tool: "resolve_color",
        action: "apply_lut",
        description: "Apply creative LUT",
        icon: Palette,
      },
      {
        tool: "resolve_color",
        action: "adjust_wheels",
        description: "Fine-tune color wheels",
        icon: Palette,
      },
      {
        tool: "resolve_render",
        action: "timeline",
        description: "Render final output",
        icon: MonitorPlay,
      },
    ],
...
resolve_render("timeline", output_path="C:/output/")`,
  },
  {
    ...
    steps: [
      {
        tool: "resolve_fairlight",
        action: "open_page",
        description: "Open Fairlight page",
        icon: Music2,
      },
      {
        tool: "resolve_fairlight",
        action: "track_eq",
        description: "Set EQ on dialogue track",
        icon: Music2,
        params: "Band 1, -3dB, 200Hz",
      },
      {
        tool: "resolve_fairlight",
        action: "track_send",
        description: "Send to reverb bus",
        icon: Music2,
      },
      {
        tool: "resolve_audio",
        action: "normalize",
        description: "Normalize to -23 LUFS",
        icon: Music2,
      },
      {
        tool: "resolve_render",
        action: "timeline",
        description: "Export with mastered audio",
        icon: MonitorPlay,
      },
    ],
...
resolve_audio("normalize", target_level=-23.0)`,
  },
  {
    ...
    steps: [
      {
        tool: "resolve_subtitle",
        action: "import_srt",
        description: "Load SRT file",
        icon: Subtitles,
      },
      {
        tool: "resolve_subtitle",
        action: "get",
        description: "Review all subtitles",
        icon: Subtitles,
      },
      {
        tool: "resolve_subtitle",
        action: "edit",
        description: "Fix timing/text",
        icon: Subtitles,
      },
      {
        tool: "resolve_subtitle",
        action: "export_srt",
        description: "Export finalized SRT",
        icon: Subtitles,
      },
    ],
    ...
    steps: [
      {
        tool: "resolve_color",
        action: "grab_still",
        description: "Grab reference still",
        icon: Palette,
      },
      {
        tool: "resolve_color",
        action: "adjust_wheels",
        description: "Try alternate grade",
        icon: Palette,
      },
      {
        tool: "resolve_color",
        action: "grab_still",
        description: "Grab version 2",
        icon: Palette,
      },
      {
        tool: "resolve_color",
      ...
      {
        tool: "resolve_color",
        action: "apply_grade_from_still",
        description: "Apply chosen grade",
        icon: Palette,
      },
    ],
    ...
    steps: [
      {
        tool: "resolve_timeline",
        action: "add_marker",
        description: "Place VFX marker",
        icon: Clock,
        params: "frame 120, Red",
      },
      {
        tool: "resolve_timeline",
        action: "add_keyframe",
        description: "Keyframe zoom at 0",
        icon: Clock,
        params: "Zoom=1.0",
      },
      {
        tool: "resolve_timeline",
        action: "add_keyframe",
        description: "Keyframe zoom at 48",
        icon: Clock,
        params: "Zoom=1.5",
      },
      {
        ...
        description: "Verify animation curve",
        icon: Clock,
      },
      {
        tool: "resolve_timeline",
        action: "get_markers",
        description: "Review marker list",
        icon: Clock,
      },
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        tool: "resolve_render",
        action: "timeline",
        description: "Render Timeline A",
        icon: MonitorPlay,
      },
      {
        tool: "resolve_render",
        action: "timeline",
        description: "Render Timeline B",
        icon: MonitorPlay,
      },
      {
        tool: "resolve_render",
        action: "job_status",
        description: "Check all jobs",
        icon: MonitorPlay,
      },
    ],
    ...
    steps: [
      {
        tool: "CLI",
        action: "open-project",
        description: "Open target project",
        icon: Terminal,
      },
      {
        tool: "CLI",
        action: "import-media",
        description: "Import source media",
        icon: Terminal,
      },
      {
        tool: "CLI",
      ...
      },
      {
        tool: "CLI",
        action: "render",
        description: "Export final output",
        icon: Terminal,
      },
    ],
              ...
              >
                ...
                {selectedWorkflow?.id === workflow.id && (
                  <div className="space-y-2 mt-3 pt-3 border-t border-slate-800">
                    ...
                    <Progress
                      value={demoStep >= 0 ? ((demoStep + 1) / workflow.steps.length) * 100 : 0}
                      className="h-1"
                    />
                        ...
                        return (
                          ...
                          >
                            <Icon
                              className={cn(
                                "h-4 w-4 mb-1",
                                done ? (step.tool === "CLI" ? "text-slate-300" : "text-blue-400") : "",
                              )}
                            />
            ...
            <ScrollArea className="h-72">
              <div className="space-y-2 pr-3">
                {[
                  {
                    tool: "resolve_project",
                    actions: ["create", "open", "list", "get_settings", "update_settings"],
                  },
                  {
                    tool: "resolve_media",
                    actions: ["import", "list", "create_folder", "get_metadata"],
                  },
                  {
                    tool: "resolve_timeline",
                    actions: [
                  ...
                  {
                    tool: "resolve_render",
                    actions: ["timeline", "presets", "with_preset", "job_status"],
                  },
                  {
                    tool: "resolve_audio",
                    actions: ["get_tracks", "add_effect", "adjust_levels", "normalize"],
                  },
                  {
                    tool: "resolve_fairlight",
                    actions: [
                  ...
                  {
                    tool: "resolve_subtitle",
                    actions: ["add", "get", "edit", "delete", "import_srt", "export_srt"],
                  },
                  {
                    tool: "resolve_system",
                    actions: ["info", "status", "health", "help", "host_status", "host_launch"],
                  },
                ].map(({ tool, actions }) => (
                  <div
                    key={tool}
          ...
          <CardContent>
            <ScrollArea className="h-72">
              <div className="space-y-3 pr-3">
                {[
                  {
                    cmd: "davinci-resolve-mcp",
                    desc: "Start MCP server (stdio for Claude Desktop/Cursor)",
                  },
                  {
                    cmd: "davinci-resolve-mcp start",
                    desc: "Start HTTP MCP server on port 8000",
                  },
                  {
                    cmd: "davinci-resolve-mcp web",
                    desc: "Start webapp API backend on port 10843",
                  },
                  {
                    cmd: "davinci-resolve-mcp check",
                    desc: "Verify Resolve installation and connection",
                  },
                  {
                    cmd: "davinci-resolve-mcp run-script <script.py>",
                    desc: "Execute arbitrary Resolve Python script",
                  },
                  {
                    cmd: "davinci-resolve-mcp render <output>",
                    desc: "Render timeline from CLI (--timeline, --format, --codec)",
                  },
                  {
                    cmd: "davinci-resolve-mcp import-media <paths...>",
                    desc: "Import media files (--folder, --list)",
                  },
                  {
                    cmd: "davinci-resolve-mcp open-project <name>",
                    desc: "Open/create project (--create)",
                  },
                ].map(({ cmd, desc }) => (
        ...
        <CardContent>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              {
                title: "Markers",
                desc: "Add/get/delete timeline markers with 16 colors, names, notes, and duration",
                icon: Clock,
              },
              {
                title: "Keyframes",
                desc: "Add/delete/get keyframes on clip properties (Zoom, Position, Speed)",
                icon: Play,
              },
              {
                title: "Subtitles",
                desc: "Full SRT import/export, add/edit/delete subtitle items on subtitle tracks",
                icon: Subtitles,
              },
              {
                title: "Gallery Stills",
                desc: "Grab stills, list gallery, apply grades from stills for versioning",
                icon: Palette,
              },
              {
                title: "EQ & Sends",
                desc: "6-band parametric EQ, track sends to buses, bus configuration, automation",
                icon: Music2,
              },
              {
                title: "CLI Scripting",
                desc: "Run arbitrary Resolve Python scripts with pre-initialized globals",
                icon: Terminal,
              },
              {
                title: "Render CLI",
                desc: "Direct timeline rendering with format/codec/resolution options",
                icon: MonitorPlay,
              },
              {
                title: "Import CLI",
                desc: "Bulk media import with folder targeting from command line",
                icon: Upload,
              },
