            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                <Card className="border-slate-800 bg-slate-950/50">
                    <CardHeader>
                        ...
                        <CardDescription className="text-slate-400">
                            Perform batch cuts and clip additions
                        </CardDescription>
                    </CardHeader>
                ...
                <Card className="border-slate-800 bg-slate-950/50">
                    <CardHeader>
                        ...
                        <CardDescription className="text-slate-400">
                            Apply and sync LUTs across timelines
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        <Button variant="outline" className="w-full border-slate-800 text-slate-300">Sync Primary Nodes</Button>
                    </CardContent>
                </Card>
                ...
                <Card className="border-slate-800 bg-slate-950/50">
                    <CardHeader>
                        ...
                        <CardDescription className="text-slate-400">
                            Monitor and manage batch render jobs
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        ...
                        <Button variant="ghost" className="w-full text-slate-400 hover:text-white">View Render Queue</Button>
                    </CardContent>
                </Card>
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-2">
                <Card className="border-slate-800 bg-slate-950/50">
                    ...
                    <CardContent className="flex gap-4">
                        <Button variant="outline" className="flex-1 border-slate-800">Clear Unused Media</Button>
                        <Button variant="outline" className="flex-1 border-slate-800">Verify Proxies</Button>
                    </CardContent>
                </Card>
                ...
                <Card className="border-slate-800 bg-slate-950/50">
                    ...
                    <CardContent className="flex gap-4">
                        <Button variant="outline" className="flex-1 border-slate-800">List Projects</Button>
