        ...
        <div className="space-y-6">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                ...
                <Card className="border-slate-800 bg-slate-950/50">
                    ...
                    <CardContent>
                        <Button variant="outline" className="w-full border-slate-800 text-amber-400 hover:bg-amber-950/30">Start Analysis</Button>
                    </CardContent>
                </Card>
                ...
                <Card className="border-slate-800 bg-slate-950/50">
                    ...
                    <CardContent>
                        <Button variant="outline" className="w-full border-slate-800 text-blue-400 hover:bg-blue-950/30">Scan & Relink</Button>
                    </CardContent>
                </Card>
            </div>
        </div>
